...
running command...
$ m30pm (--version)
m30pm/0.2.0-beta.0 linux-x64 node-v25.9.0
$ m30pm --help [COMMAND]
USAGE
  $ m30pm COMMAND
...
...
_See code: [src/commands/project/create.ts](https://github.com/dof-initiative/m30pm/blob/v0.2.0-beta.0/src/commands/project/create.ts)_
<!-- commandsstop -->
